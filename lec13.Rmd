...
ggplot()  +
  ...
  geom_sf_text(data = scand_prov_pts, aes(geometry=geometry, label=plotlab),
       check_overlap = TRUE, size = 3) +
  scale_fill_gradientn(colors = pal, limits = c(-15, 15), breaks = seq(-15, 15, by = 5)) +
