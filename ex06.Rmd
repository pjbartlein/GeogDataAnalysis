...
Before going on, compare the two blocks of code to see what sort of things have be changed to plot different variables (e.g. the range of values that are plotted).
